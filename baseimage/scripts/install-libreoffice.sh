...
# Add Collabora repos
echo "deb https://collaboraoffice.com/${REPOS:-repos}/CollaboraOnline/3.0/customer-ubuntu1604-${SECRET_KEY} /" >> /etc/apt/sources.list.d/collabora.list
...
# Collabora Office does not recognize its own dictionaries :(
