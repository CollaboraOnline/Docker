...
# Add Collabora repos
echo "deb https://collaboraoffice.com/${REPOS:-repos}/CollaboraOnline/6.4/customer-ubuntu1804-${SECRET_KEY} /" >> /etc/apt/sources.list.d/collabora.list
